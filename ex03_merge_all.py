...
def main():
    ...
    ************************************************************************
    ...
    for (year,num) in amount:
        g = open("C:/Users/User/Desktop/file/result/{0}/text0.txt".format(year), 'a', encoding = "utf-8")
        
        tot = num + 1
        for i in range(1,tot):
            f = open("C:/Users/User/Desktop/file/result/{0}/text{1}.txt".format(year,i), 'r', encoding = "utf-8")
            line = f.readlines()            
            for word in line:
                g.write(word)
            g.writelines(line)    
